    ...
    return(
        ...
        <table className='w-full'>
            ...
            { Array.from({length : 10}).map( (_, i)=>{
                return(
                    <tr key={innerHeight} className='border border-white/10 hover:bg-white/10'>
                    <td className='py-3 px-4 text-sm  text-zinc-300'>
                        <input className='size-4 bg-black/20 rounded border-white/10 accent-o'type="checkbox" name="" id="" />
                    </td>
                    <td className='py-3 px-4 text-sm  text-zinc-300'>452355</td>
                    <td className='py-3 px-4 text-sm  text-zinc-300'>
            ...
            <tfoot>
                <tr>
                    <td className='py-3 px-4 text-sm text-zinc-300' colSpan={3} > Mostrando 10 de 224 itens</td>
